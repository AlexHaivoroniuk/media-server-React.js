    ...
    if (props.toggle) {
        filters = (
            <div className={styles.Filters}>
                <form action="" ref={(node) => {form = node}}>
                    <fieldset>
                        <legend>Genre</legend>
                    ...
                    <Button
                        clicked={(e) => {e.preventDefault(); props.filterMovies()}}
                        btnSize="md"
                    >
                        Filter<Icon>fa fa-filter</Icon>
                    </Button>
                    <Button
                        clicked={(e) => {resetFilters(e)}}
                        btnSize="md"
                        btnColor="danger"
                    >
                        Clear<Icon>fa fa-trash</Icon>
                    </Button>
                </form>
            </div>
        )
